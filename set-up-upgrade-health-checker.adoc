...
Além disso, certifique-se de que a máquina virtual possa se conectar ao endpoint de telemetria (https://support.netapp.com/[] e  https://api.activeiq.netapp.com[] por meio de HTTPS para permitir que a NetApp receba informações do AutoSupport sobre seus planos de atualização.
